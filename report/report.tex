...
For that, we can categorize the standards into four categories( a complete list of all existing standards can be found in \cite{mohaisen2017rethinking}):
\begin{enumerate}
\item Enumerations
...
I will only focus on the three that I've cited before as we can see in \cite{fransen2015cyber} that the most promosing standards for a threat sharing intelligence sharing infrastructure are CybOX, STIX and TAXII. They have been developed under coordination of the MITRE Corporation and have very strong momentum in adoption by industry leaders and threat intelligence communities such as the Financial Services - Information Sharing and Analysis Center (FS-ISAC).\\
...
Now that the subject seems clearer, there are a lot of different possibilities that could be explored. This chapter will be the opportunity to dwell on different possibilities in order to compare their strong points as well as their weakness.
