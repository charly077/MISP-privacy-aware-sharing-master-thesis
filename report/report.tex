...
There are also other alternatives to bloom filter like the ones explained in \cite{putze2007cache} but also one particularly interesting called Cuckoo Filters \cite{fan2014cuckoo} that could be considered as a further work.
