...
%TODO
\improvement{Attention explain how to use it => Cryptoname = "bloomy\_" + name}
\improvement{Explain how it works (workflow)}
...
\subsection{Analyse pbkdf2 module vs bloomy\_pbkdf2 module}
