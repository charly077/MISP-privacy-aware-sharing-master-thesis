...
\subsection{MISP in a few Pictures}
...
And, on the other side, when there is a match, rules can be used to get back the information needed to retrieve the event information from MISP. \improvement{Add an explanation on the message generated and how we could use it to find informations on an event}\\
