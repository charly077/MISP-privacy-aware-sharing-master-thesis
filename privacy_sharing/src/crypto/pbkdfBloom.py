...
Check if the mix between bloom filter and key derivation 
function can help improve the performance of the system
significantly without revealing too many information
to an attacker.
